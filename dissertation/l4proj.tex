...
We will identify some gamification characteristics and provide some examples of how we could apply them to cryptography.
...
To apply gamification to certain context, \citet{cugelman_gamification:_2013} has identified 7 important components for a good gamification. 
...
and this is usually the spot where cryptography fails \citep{lazar_why_nodate}. We will first investigate why cryptography itself is not the issue in most cases.
Then, we will discuss the common mistakes that are made, and how they could be recovered from.
...
implemented cryptography. This is mostly due to attackers not having the skills, the infrastructure, or the time to do it. 
