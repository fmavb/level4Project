...
(for example, the key binding varied between quests). 
Hence, it has been decided to maintain to keep the already built map, to improve existing quests, and to construct new challenges where required.
...
\begin{itemize}
    ...
    \item Present cryptography origins;
    \item Present the three cryptographic algorithms;
...
and to supplement it where possible.
The CSF course introduces students to cryptography basics. 
It presents and explains the two main operations in cryptography: encryption, decryption, and hashing.

It then proceeds to demonstrate how symmetric and asymmetric cryptography work and where they are applied

\subsection{Cryptography origins}

\subsection{Three cryptographic algorithms}

\subsection{Mistakes in cryptography}

\section{Towards a more specific set of requirements}
